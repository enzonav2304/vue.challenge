        ...
        <div data-thq="thq-mobile-menu" class="home-mobile-menu1 mobileMenu">
          <div class="home-nav">
            ...
            <nav class="home-links1">
              ...
              <span class="home-nav22 bodySmall">Login</span>
              <span class="home-nav32 bodySmall">Sign Up</span>
            </nav>
      ...
      <div class="home-hero1 heroContainer">
        <div class="home-container1">
          <h1 class="home-hero-heading heading1">
            La tua piattaforma di Blog Competitivo
          </h1>
          <h3 class="home-text">Quando le parole fanno la differenza</h3>
          <span class="home-hero-sub-heading bodyLarge">
            <span>
              <span>
                <span>Login to your account or create new one</span>
                <span><span v-html="rawma7w"></span></span>
              </span>
              <span>
                <span><span v-html="raw0kpt"></span></span>
                <span><span v-html="rawshdj"></span></span>
              </span>
            </span>
            <span>
              <span>
                <span><span v-html="raw5jo4"></span></span>
                <span><span v-html="rawiy65"></span></span>
              </span>
              <span>
                <span><span v-html="raw92a6"></span></span>
                <span><span v-html="raw2e7l"></span></span>
              </span>
            </span>
          </span>
          <div class="home-btn-group">
            <router-link to="/login" class="home-hero-button1 buttonFilled">
              Login
            </router-link>
            <router-link to="/register" class="home-hero-button2 buttonFlat">
              Register
            </router-link>
          </div>
        </div>
    ...
    <div class="home-footer">
      <footer class="footerContainer home-footer1">
        ...
        <div class="home-container2">
          <span class="bodySmall home-text15">
...
export default {
  ...
  metaInfo: {
    title: 'Handmade Sane Eland',
    meta: [
      {
        property: 'og:title',
        content: 'Handmade Sane Eland',
      },
    ],
  },
}
